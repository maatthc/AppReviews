'''
Description: Prototype for scraping Apple App Store on iTunes and
Google Play Apps reviews/Ratings
...
def main():
    ...
    itunes_review_url = "http://itunes.apple.com/rss/\
        customerreviews/id=400274934/json"

    # Handle iTunes Rating
    # json_rating_url = ur.urlopen(itunes_rating_url)
    # json_rating_res = json.load(json_rating_url)

    # Handle iTunes Reviews
    json_review_url = ur.urlopen(itunes_review_url)
    ...
    <div class="review-text">
        <span class="review-title">??</span> I had to redo the same thing
         twice. When I signed out and logged back in they weren't even
          doing anything. Can't progress in the game if that keeps happening.
        <div class="paragraph-end details-light"></div>
    </div>
    <div class="featured-review-star-rating">
        <div aria-label=" Rated 1 stars out of five stars "
